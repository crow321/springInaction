...
public class Main {
	public static void main(String[] args) throws PerformanceException {
		ApplicationContext context = new ClassPathXmlApplicationContext("part1/springIdol.xml");
        ...
        ApplicationContext context1 = new ClassPathXmlApplicationContext("part1/aop.xml");
